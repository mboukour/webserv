...
HTTP = Http/AHttp/AHttp.cpp Http/HttpRequest/HttpRequest.cpp Http/HttpResponse/HttpResponse.cpp Http/HttpResponse/HttpResponseErrorMaker/HttpResponseErrorMaker.cpp Http/HttpResponse/Methods/handleDeleteRequest.cpp Http/HttpResponse/Methods/handleGetRequest.cpp
SRC += $(EXCEPTIONS) $(HTTP)
OBJ = $(SRC:.cpp=.o)
